...
export default function Servise() {
  return (
    <section
      ...
      className="flex flex-col gap-8 bg-gradient-to-l  from-[#d4e0fc] via-white to-[#f9eff1]"
    >
      <div className="flex flex-col justify-center items-center px-10 py-5 gap-5">
        <h1 className="text-[14px]">Service</h1>
        <h2 className="flex justify-center items-center text-[12px]">
      ...
      <div className="flex flex-col justify-center items-center px-10 gap-5">
        <div className=" flex flex-col rounded-2xl gap-3 shadow-2xl p-3">
          ...
          <h2 className="text-[14px] ">sent Text Instantly</h2>
        ...
        <div className=" flex flex-col rounded-2xl gap-3 shadow-2xl p-3">
          ...
          <h2 className="text-[14px] ">Better Organized</h2>
          <p className="text-[12px]">
        ...
        <div className=" flex flex-col rounded-2xl gap-3 shadow-2xl p-3">
          ...
          <h2 className="text-[14px] ">Analytical Statistics</h2>
          <p className="text-[12px]">
